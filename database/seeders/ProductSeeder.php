...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Récupérer les catégories et types de produits
        $categories = Category::all();
        $productTypes = ProductType::all();

        if ($categories->isEmpty() || $productTypes->isEmpty()) {
            $this->command->error('❌ Veuillez d\'abord exécuter CategorySeeder et ProductTypeSeeder !');
            return;
        }

        // Trouver ou créer les catégories nécessaires
        $phoneCategory = Category::where('name', 'LIKE', '%téléphone%')
        ...
        $phoneType = $productTypes->firstWhere('name', 'LIKE', '%téléphone%')
        ...
        $this->command->info('📱 Création des produits de test pour le filtrage...');
        ...
        $phones = [
            ...
            [
                ...
                'description' => 'Smartphone Tecno Spark 20 Pro avec écran 6.78" et 8GB RAM',
                'price' => 95000,
                'cost_price' => 75000,
                'stock_quantity' => 25,
                'min_stock_alert' => 5,
            ...
            [
                ...
                'description' => 'Tecno Camon 20 Pro avec caméra 64MP et processeur Helio G99',
                'price' => 125000,
                'cost_price' => 100000,
                'stock_quantity' => 18,
                'min_stock_alert' => 3,
            ...
            [
                ...
                'description' => 'Tecno Phantom X2 haut de gamme avec écran AMOLED',
                'price' => 180000,
                'cost_price' => 150000,
                'stock_quantity' => 10,
                'min_stock_alert' => 2,
            ...
            [
                'name' => 'Tecno Pop 8',
                'description' => 'Tecno Pop 8 entrée de gamme avec Android Go',
                'price' => 55000,
                'cost_price' => 40000,
                'stock_quantity' => 35,
                'min_stock_alert' => 10,
            ...
            [
                ...
                'description' => 'Infinix Hot 40 Pro avec écran 6.78" et 8GB RAM',
                'price' => 110000,
                'cost_price' => 85000,
                'stock_quantity' => 22,
                'min_stock_alert' => 5,
            ...
            [
                ...
                'description' => 'Infinix Zero 30 avec caméra 108MP',
                'price' => 160000,
                'cost_price' => 130000,
                'stock_quantity' => 12,
                'min_stock_alert' => 2,
            ...
            [
                'name' => 'Itel A70',
                'description' => 'Itel A70 avec écran 6.6" et 4GB RAM',
                'price' => 75000,
                'cost_price' => 60000,
                'stock_quantity' => 28,
                'min_stock_alert' => 7,
            ...
            [
                'name' => 'Itel S23',
                'description' => 'Itel S23 avec caméra 50MP',
                'price' => 85000,
                'cost_price' => 65000,
                'stock_quantity' => 20,
                'min_stock_alert' => 5,
            ...
            [
                ...
                'description' => 'Samsung Galaxy A54 avec écran Super AMOLED 6.4"',
                'price' => 220000,
                'cost_price' => 180000,
                'stock_quantity' => 15,
                'min_stock_alert' => 3,
            ...
            [
                ...
                'description' => 'Samsung Galaxy S24 avec IA intégrée',
                'price' => 450000,
                'cost_price' => 380000,
                'stock_quantity' => 8,
                'min_stock_alert' => 2,
            ...
            [
                'name' => 'iPhone 15 Pro',
                'description' => 'iPhone 15 Pro avec puce A17 Pro et caméra 48MP',
                'price' => 850000,
                'cost_price' => 700000,
                'stock_quantity' => 12,
                'min_stock_alert' => 2,
            ...
            [
                'name' => 'iPhone 13',
                'description' => 'iPhone 13 avec écran Super Retina XDR',
                'price' => 550000,
                'cost_price' => 450000,
                'stock_quantity' => 25,
                'min_stock_alert' => 5,
            ...
            [
                'name' => 'Redmi A3',
                'description' => 'Redmi A3 entrée de gamme avec Android Go',
                'price' => 60000,
                'cost_price' => 45000,
                'stock_quantity' => 40,
                'min_stock_alert' => 10,
            ...
            [
                'name' => 'Oppo Reno 11',
                'description' => 'Oppo Reno 11 avec caméra 50MP',
                'price' => 280000,
                'cost_price' => 230000,
                'stock_quantity' => 10,
                'min_stock_alert' => 2,
            ...
            [
                'name' => 'Huawei Nova 12',
                'description' => 'Huawei Nova 12 avec écran OLED',
                'price' => 240000,
                'cost_price' => 200000,
                'stock_quantity' => 12,
                'min_stock_alert' => 2,
            ...
            [
                'name' => 'Nokia 105',
                'description' => 'Téléphone à touches Nokia 105 avec batterie longue durée',
                'price' => 25000,
                'cost_price' => 18000,
                'stock_quantity' => 50,
                'min_stock_alert' => 15,
            ...
            [
                'name' => 'Itel T531',
                'description' => 'Téléphone à touches Itel T531',
                'price' => 20000,
                'cost_price' => 15000,
                'stock_quantity' => 45,
                'min_stock_alert' => 12,
            ...
            [
                'name' => 'Vivo Y100',
                'description' => 'Vivo Y100 avec écran AMOLED et charge rapide',
                'price' => 165000,
                'cost_price' => 135000,
                'stock_quantity' => 14,
                'min_stock_alert' => 3,
            ...
            [
                'name' => 'Vivo V29',
                'description' => 'Vivo V29 avec caméra 50MP et écran 6.78"',
                'price' => 295000,
                'cost_price' => 240000,
                'stock_quantity' => 9,
                'min_stock_alert' => 2,
            ...
            [
                'name' => 'OnePlus Nord 3',
                'description' => 'OnePlus Nord 3 avec écran 120Hz',
                'price' => 320000,
                'cost_price' => 270000,
                'stock_quantity' => 11,
                'min_stock_alert' => 2,
            ...
            [
                ...
                'description' => 'Motorola Moto G84 avec écran pOLED',
                'price' => 185000,
                'cost_price' => 150000,
                'stock_quantity' => 13,
                'min_stock_alert' => 3,
            ...
            [
                'name' => 'Honor 90',
                'description' => 'Honor 90 avec caméra 200MP',
                'price' => 260000,
                'cost_price' => 220000,
                'stock_quantity' => 10,
                'min_stock_alert' => 2,
            ...
            [
                ...
                'description' => 'Google Pixel 7a avec caméra 64MP',
                'price' => 350000,
                'cost_price' => 290000,
                'stock_quantity' => 9,
                'min_stock_alert' => 2,
        ...
        $accessories = [
            ...
            // Câbles
            [
                'name' => 'Câble USB Type-C 2m',
                'description' => 'Câble USB Type-C 2 mètres pour charge et transfert de données',
                'price' => 6000,
                'cost_price' => 3500,
                'stock_quantity' => 80,
                'min_stock_alert' => 20,
                'type_accessory' => 'Câble USB',
                'compatibility' => 'Type-C universel',
                'category_id' => $accessoryCategory->id,
                'product_type_id' => $accessoryType->id,
                'status' => 'active',
            ...
            [
                ...
                'description' => 'Câble Lightning Apple original 1 mètre',
                'price' => 10000,
                'cost_price' => 6000,
                'stock_quantity' => 55,
                'min_stock_alert' => 15,
            ...
            [
                'name' => 'Câble Micro-USB 1.5m',
                'description' => 'Câble Micro-USB 1.5 mètres',
                'price' => 4000,
                'cost_price' => 2500,
                'stock_quantity' => 70,
                'min_stock_alert' => 18,
            ...
            // Écouteurs
            [
                'name' => 'Écouteurs filaires avec micro',
                'description' => 'Écouteurs filaires avec micro et contrôle volume',
                'price' => 5000,
                'cost_price' => 3000,
                'stock_quantity' => 90,
                'min_stock_alert' => 25,
                'type_accessory' => 'Écouteurs filaires',
            ...
            [
                ...
                'description' => 'Écouteurs Bluetooth True Wireless avec boîtier de charge',
                'price' => 18000,
                'cost_price' => 12000,
                'stock_quantity' => 45,
                'min_stock_alert' => 10,
                'type_accessory' => 'Écouteurs Bluetooth',
            ...
            // Films protecteurs
            [
                'name' => 'Film protecteur verre trempé',
                'description' => 'Film protecteur en verre trempé 9H',
                'price' => 4000,
                'cost_price' => 2000,
                'stock_quantity' => 85,
                'min_stock_alert' => 20,
                'type_accessory' => 'Film protecteur (verre trempé)',
                'compatibility' => 'Android universel',
                'category_id' => $accessoryCategory->id,
                'product_type_id' => $accessoryType->id,
                'status' => 'active',
            ...
            [
                ...
                'description' => 'Film protecteur verre trempé pour iPhone',
                'price' => 6000,
                'cost_price' => 3000,
                'stock_quantity' => 50,
                'min_stock_alert' => 12,
            ...
            [
                ...
                'description' => 'Support magnétique pour téléphone en voiture',
                'price' => 8000,
                'cost_price' => 5000,
                'stock_quantity' => 30,
                'min_stock_alert' => 8,
                'type_accessory' => 'Support téléphone voiture',
                'compatibility' => 'Android universel',
                'category_id' => $accessoryCategory->id,
                'product_type_id' => $accessoryType->id,
                'status' => 'active',
            ...
            [
                ...
                'description' => 'Support réglable pour téléphone sur bureau',
                'price' => 7000,
                'cost_price' => 4000,
                'stock_quantity' => 35,
                'min_stock_alert' => 9,
            ...
            // Autres accessoires
            [
                'name' => 'Carte mémoire microSD 64GB',
                'description' => 'Carte mémoire microSD 64GB classe 10',
                'price' => 12000,
                'cost_price' => 8000,
                'stock_quantity' => 40,
                'min_stock_alert' => 10,
                'type_accessory' => 'Carte mémoire (SD / microSD)',
                'compatibility' => 'Android universel',
                'category_id' => $accessoryCategory->id,
                'product_type_id' => $accessoryType->id,
                'status' => 'active',
            ...
            [
                ...
                'description' => 'Haut-parleur Bluetooth avec batterie intégrée',
                'price' => 22000,
                'cost_price' => 15000,
                'stock_quantity' => 25,
                'min_stock_alert' => 6,
            ...
            [
                ...
                'description' => 'Câble USB-C vers Lightning pour iPhone',
                'price' => 12000,
                'cost_price' => 7000,
                'stock_quantity' => 35,
                'min_stock_alert' => 9,
            ...
            [
                'name' => 'Câble USB-C 3m',
                'description' => 'Câble USB-C 3 mètres pour charge longue distance',
                'price' => 8000,
                'cost_price' => 5000,
                'stock_quantity' => 50,
                'min_stock_alert' => 12,
            ...
            [
                'name' => 'Casque Bluetooth avec réduction de bruit',
            ...
            [
                'name' => 'Trépied photo / selfie stick',
                'description' => 'Trépied télescopique pour selfies et photos',
                'price' => 10000,
                'cost_price' => 6000,
                'stock_quantity' => 28,
                'min_stock_alert' => 7,
                'type_accessory' => 'Trépied photo / selfie stick',
                'compatibility' => 'Android universel',
                'category_id' => $accessoryCategory->id,
                'product_type_id' => $accessoryType->id,
                'status' => 'active',
            ...
            [
                ...
                'description' => 'Support magnétique pour tableau de bord voiture',
                'price' => 9000,
                'cost_price' => 5500,
                'stock_quantity' => 32,
                'min_stock_alert' => 8,
            ...
            [
                'name' => 'Étui tablette avec clavier',
                'description' => 'Étui tablette avec clavier Bluetooth intégré',
                'price' => 32000,
                'cost_price' => 22000,
                'stock_quantity' => 15,
                'min_stock_alert' => 4,
                'type_accessory' => 'Étui tablette',
            ...
            [
                ...
                'description' => 'Dock de recharge pour 3 appareils simultanés',
                'price' => 25000,
                'cost_price' => 16000,
                'stock_quantity' => 20,
                'min_stock_alert' => 5,
            ...
            [
                'name' => 'Carte mémoire microSD 128GB',
                'description' => 'Carte mémoire microSD 128GB classe 10',
                'price' => 18000,
                'cost_price' => 12000,
                'stock_quantity' => 35,
                'min_stock_alert' => 9,
            ...
            [
                ...
                'description' => 'Kit adaptateur SIM et outil d\'éjection',
                'price' => 2000,
                'cost_price' => 1000,
                'stock_quantity' => 80,
                'min_stock_alert' => 20,
            ...
            [
                'name' => 'Connecteur magnétique USB-C',
                'description' => 'Connecteur magnétique USB-C pour charge facile',
                'price' => 6000,
                'cost_price' => 3500,
                'stock_quantity' => 38,
                'min_stock_alert' => 10,
                'type_accessory' => 'Connecteur magnétique',
                'compatibility' => 'Type-C universel',
                'category_id' => $accessoryCategory->id,
                'product_type_id' => $accessoryType->id,
                'status' => 'active',
            ...
            [
                'name' => 'Câble auxiliaire audio 3.5mm',
                'description' => 'Câble auxiliaire audio jack 3.5mm 1.5m',
                'price' => 4000,
                'cost_price' => 2500,
                'stock_quantity' => 55,
                'min_stock_alert' => 14,
                'type_accessory' => 'Câble auxiliaire audio (jack 3.5 mm)',
                'compatibility' => 'Casques jack 3.5 mm',
                'category_id' => $accessoryCategory->id,
                'product_type_id' => $accessoryType->id,
                'status' => 'active',
            ...
            [
                ...
                'description' => 'Anneau lumineux LED pour selfies et vidéos',
                'price' => 12000,
                'cost_price' => 7000,
                'stock_quantity' => 30,
                'min_stock_alert' => 8,
        ...
        foreach ($allProducts as $productData) {
            try {
                // Générer SKU et slug automatiquement
                ...
                $this->command->error("❌ Erreur création produit {$productData['name']}: " . $e->getMessage());
            }
        }

        $this->command->info("✅ {$created} produits créés avec succès !");
        $this->command->info("📱 Téléphones: " . count($phones));
        $this->command->info("🔌 Accessoires: " . count($accessories));
    }
}
